...
libraryDependencies += "com.github.slack-scala-client" %% "slack-scala-client" % "0.2.16" withJavadoc() withSources()
libraryDependencies += "com.slack.api" % "slack-api-client" % "1.9.0"
